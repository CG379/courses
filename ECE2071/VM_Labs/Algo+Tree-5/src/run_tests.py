...
def test_collatz():
	...
	if programOutput == expectedOutput:
		print(f"Test {testNumber} passed! - bubble_sort with input {programInput}")
	else:
		print(f"Test {testNumber} failed! - bubble_sort with input {programInput}\n" + 
